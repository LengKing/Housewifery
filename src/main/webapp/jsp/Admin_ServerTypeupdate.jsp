...
<div>
    <table style="text-align: center">
        <tr>
            <h2 style="margin: 8px; text-align: center">修改服务类型</h2>
        </tr>
        <tr>
        ...
        <tr>
            <td style="margin: 8px"><input onclick="updatesTypes(this)" type="button" value="修改" class="layui-btn layui-btn-primary"></td>
