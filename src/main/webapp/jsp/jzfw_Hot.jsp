...
<div>
    ...
    <script type="text/html" id="barDemo">
        <a class="layui-btn layui-btn-danger layui-btn-xs" onclick="update(this)">下单</a>
    </script>
    <script>
        var path = $("#path").val();
        //加载table模块
        layui.use(['table', 'layer', 'laypage'], function () {
            ...
            table.render({
                ...
                , toolbar: 'default'
                , cols: [[ //表头
                    {field: 'serviceName', title: '服务名', width: 180, sort: true}
                    , {field: 'hotCount', title: '热度', width: 180}
