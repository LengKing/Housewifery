...
<div>
    <table style="text-align: center">
        <tr>
            <h2 style="margin: 8px; text-align: center">新增培训计划</h2>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="margin: 8px">
                <select id="length" name="length" lay-verify="required"  style="margin: 8px ;width: 197px;height: 38px">
        ...
        <tr>
            <td style="margin: 8px"><input onclick="addTrain(this)" type="button" value="提交" class="layui-btn layui-btn-primary"></td>
