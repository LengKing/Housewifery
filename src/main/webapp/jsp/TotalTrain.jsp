            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-header">培训统计</div>
...
<%--                            <label style="float: right">注册时间</label>--%>
                ...
                <div class="layui-col-sm12 layui-col-md6">
                    <div class="layui-card">
                        <div class="layui-card-header">单日培训次数</div>
                ...
                <div class="layui-col-sm12 layui-col-md6">
                    <div class="layui-card">
                        <div class="layui-card-header">培训次数增长曲线</div>
                        <div class="layui-card-body" style="min-height: 400px;">
    ...
    <script type="text/javascript">
        $("#select").click(function () {
            ...
            $.ajax({
                ...
                url:"${pageContext.request.contextPath}/train/lineTrain",
                dataType:"json",
                beforeSend:function(){
    ...
    $.ajax({
        data:{"time":JSON.stringify(diffdate)},
        url:"${pageContext.request.contextPath}/train/barTrain",
        dataType:"json",
        beforeSend:function(){
            if (startDate==""||endDate==""){
                layer.alert("时间不能为空",{title:"提示",time:1500});
