...
<html class="x-admin-sm">
        ...
        <div class="layui-fluid">
            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body ">
                            <label>家政公司</label>
                            <input id="company" style="width: 150px;height: 25px" placeholder="请输入家政公司名字">
                           <label>下单时间</label>
                ...
                <div class="layui-col-sm12 layui-col-md6">
                    <div class="layui-card">
                        <div class="layui-card-header">每日订单数量</div>
                ...
                <div class="layui-col-sm12 layui-col-md6">
                    <div class="layui-card">
                        <div class="layui-card-header">订单增长曲线</div>
                        <div class="layui-card-body" style="min-height: 400px;">
    ...
    <script type="text/javascript">
        $("#select").click(function () {
            ...
            $.ajax({
                ...
                url:"${pageContext.request.contextPath}/order/lineOrder",
                dataType:"json",
                beforeSend:function(){
    ...
    $.ajax({
        data:{"startDate":startDate,"endDate":endDate,"company":company},
        url:"${pageContext.request.contextPath}/order/barOrder",
        dataType:"json",
        beforeSend:function(){
            if (startDate==""||endDate==""){
                layer.alert("时间不能为空",{title:"提示",time:1500});
