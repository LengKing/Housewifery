    ...
    <script>
        ...
        layui.use(['table', 'layer', 'laypage'], function () {
            ...
            table.render({
                elem: '#demo'
                , height: 510
                , url: path+'/adminTrain/getTrain' //数据接口
                ...
                , cols: [[ //表头
                    ...
                    , {field: 'startTime', title: '培训时间段', width: 150}
                    , {field: 'endTime', title: '培训时间段', width: 100}
                    , {field: 'content', title: '培训内容', width: 100}
                    , {field: 'count', title: '培训人数', width: 180}
                    , {field: 'length', title: '培训时长', width: 180}
            ...
            table.on('tool(test)', function (obj) {
                ...
                if (obj.event === 'del') {
                    layer.confirm('真的要删除吗', function (index) {
                        $.ajax({
                            url: path+"/adminTrain/deleteTrain",
                            data: {id: data.id},
