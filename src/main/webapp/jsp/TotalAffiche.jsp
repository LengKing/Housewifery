...
<html class="x-admin-sm">
            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-header">发布信息统计</div>
                ...
                <div class="layui-col-sm12 layui-col-md6">
                    <div class="layui-card">
                        <div class="layui-card-header">单日发布消息数量</div>
                ...
                <div class="layui-col-sm12 layui-col-md6">
                    <div class="layui-card">
                        <div class="layui-card-header">发布消息增长曲线</div>
                        <div class="layui-card-body" style="min-height: 400px;">
    ...
    <script type="text/javascript">
        $("#select").click(function () {
            ...
            $.ajax({
                data:{"time":JSON.stringify(diffdate)},
                url:"${pageContext.request.contextPath}/affiche/lineAffiche",
                dataType:"json",
                beforeSend:function(){
    ...
    $.ajax({
        data:{"time":JSON.stringify(diffdate)},
        url:"${pageContext.request.contextPath}/affiche/barAffiche",
        dataType:"json",
        beforeSend:function(){
            if (startDate==""||endDate==""){
                layer.alert("时间不能为空",{title:"提示",time:1500});
