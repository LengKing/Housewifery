...
<html class="x-admin-sm">
            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-header">家政公司统计</div>
                        <div class="layui-card-body ">
                           <label>入驻时间</label>
                            ...
                            &nbsp;<button type="button" id="lineCompany" class="layui-btn" style="float: right;margin-right: 8%"><i class="layui-icon">&#xe615;</i>查询</button>&nbsp;&nbsp;
                            ...
                            <label style="float: right">&nbsp;&nbsp;</label>
                            <label style="float: right">截止时间</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="layui-col-sm12 layui-col-md6">
                    <div class="layui-card">
                        <div class="layui-card-header">每日入驻公司数</div>
                ...
                <div class="layui-col-sm12 layui-col-md6">
                    <div class="layui-card">
                        <div class="layui-card-header">入驻公司总数</div>
                        <div class="layui-card-body" style="min-height: 400px;">
    ...
    <script type="text/javascript">
        $("#lineCompany").click(function () {
            var diffdate=getdiffdate($("#sDate").val(),$("#eDate").val())
            ...
            $.ajax({
                ...
                url:"${pageContext.request.contextPath}/company/lineCompany",
                dataType:"json",
    ...
    var diffdate=getdiffdate($("#startDate").val(),$("#endDate").val())
    // 基于准备好的dom，初始化echarts实例
    ...
    $.ajax({
        ...
        url:"${pageContext.request.contextPath}/company/barCompany",
        dataType:"json",
        success:function(jsonData){
            myChart.setOption({
                series: [{
