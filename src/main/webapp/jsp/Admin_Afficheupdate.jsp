...
<div>
    <table style="text-align: center">
        ...
        <tr>
            ...
            <td style="margin: 8px"> <textarea style="margin: 8px"  name="describes" id="describes" placeholder="请输入内容" class="layui-textarea"></textarea></td>
        </tr>

        <tr>
            <td style="margin: 8px"><input onclick="updateAffiches(this)" type="button" value="修改" class="layui-btn layui-btn-primary"></td>
